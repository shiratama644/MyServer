...
#### 3.6 セキュリティ (`/admin/security`)

-   **UI:** ページは「**アクセスログ**」「**ファイアウォール**」「**パッケージ更新**」の3つのタブで構成される。

##### **3.6.1 アクセスログ (Audit Log) タブ**
